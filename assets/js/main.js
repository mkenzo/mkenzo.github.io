...
const sendEmail = (e) =>{
    ...
    if(contactName.value === '' || contactEmail.value === '' || contactMessage.value === ''){
        ...
        // Show message
        contactWarning.textContent = 'Write all the input fields 📩'
    } else {
        // serviceID - templateID - #form - publicKey
        emailjs.sendForm('service_un4rnj9','template_r8panyb','#contact-form','tTk5SYzmZ8TIRcVKC')
            .then(() =>{
                // Show message and add color
                contactWarning.classList.add('color-blue')
